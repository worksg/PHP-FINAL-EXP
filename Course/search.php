...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT * FROM `demodb`.`Course` WHERE `cno`='$QUERY_ID'";
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-dark table-hover">
            ...
            ', $index, $info['cno'], $info['cname'], $info['credit'], $info['tno'], $info['cno'], $info['cno']);
    echo trim($content);
...
<body>
    ...
    <script>
        $("#searchButton").click(function () {
            ...
            if (id != ""){
            	$.post("/course/search.php", {id : id}, function(data) {
