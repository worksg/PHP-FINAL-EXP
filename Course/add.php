...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO `demodb`.`Course` VALUES ('$cno','$cname', '$credit', '$tno')";
...
<body>
						...
						<div class="col">
							<div class="card">
								<div class="card-body">
									...
									<form id="addCourseForm" modelAttribute="Course" method="post">
    ...
    function submitDetailsForm() {
			$('form#addCourseForm').serializeArray().reduce(function (obj, item) {
            ...
            $.post('/course/add.php', $('form#addCourseForm').serialize(), function (data) {
                if (data['status']) {
